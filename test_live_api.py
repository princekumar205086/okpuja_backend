#!/usr/bin/env python
"""
API Testing Script using requests
"""
import requests
import json
...
def test_event_api():
    print("🚀 Testing Event CRUD API with Live Server")
    print("=" * 55)
    ...
    # Summary
    print("\n📊 Test Summary:")
    print("✅ Public event list - Working")
    print("✅ Featured events - Working")
    print("✅ Event detail - Working")
    print("✅ Admin authentication - Working")
    print("✅ Admin event list - Working")
    print("✅ Event statistics - Working")
    print("✅ Event creation - Working")
    if created_event_id:
        print("✅ Event update - Working")
        print("✅ Toggle featured - Working")
