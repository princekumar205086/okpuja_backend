# Generated by Django 5.2 on 2025-07-31 22:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ForeignKey(blank=True, help_text='Employee/Priest assigned to handle this booking', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assigned_bookings', to=settings.AUTH_USER_MODEL)),
                ('cart', models.ForeignKey(blank=True, help_text='Original cart (kept for reference even if cart is deleted)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bookings', to='cart.cart')),
