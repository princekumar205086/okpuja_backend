# Generated by Django 5.2 on 2025-06-28 22:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('USER', 'Public User'), ('ADMIN', 'Administrator'), ('EMPLOYEE', 'Employee/Priest')], default='USER', max_length=20, verbose_name='role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to=accounts.models.user_upload_path, verbose_name='profile picture')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
